...
/**
 * SceneTrackObjectEditor.cs
 *
 * A custom editor for SceneTrackObject's
 * 
...
{
    /// <summary>
    /// Custom Editor for SceneTrackObject
    /// </summary>
    ...
    public class SceneTrackObjectEditor : UnityEditor.Editor
    {
        ...
        static List<Warnings> _warnings;
        static List<Transform> _missingObjectsOnBones; 
        static List<SceneTrackObject> _enabledChildren; 
        
        /// <summary>
        /// Single pass hash generator.
        /// </summary>
        ...
        /// <summary>
        /// Generate list of children (as buttons)
        /// </summary>
        /// <param name="m">List of children</param>
